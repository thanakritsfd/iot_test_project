...
//เรียกใช้ Method ที่เรียก api
  Future callAPIGetRoomtemp3() async {
    var dataFromCallAPI = await CallApi.getRoomTemp3();
      ...
      body: Center(
        child: Column(
          children: [
            ...
            Text(
              '-- แสดงข้อมูลแอร์ตัวที่ 3 วัน และเวลา --',
            ),
            SizedBox(
              height: 30.0,
            ),
