...
//เรียกใช้ Method ที่เรียก api
  Future callAPIGetRoomtemp1() async {
    var dataFromCallAPI = await CallApi.getRoomTemp1();
      ...
      body: Center(
        child: Column(
          children: [
            ...
            Text(
              '-- แสดงข้อมูลแอร์ตัวที่ 1 วัน และเวลา --',
            ),
            SizedBox(
              height: 30.0,
            ),
